  ...
  return (
    <div className='nav' style={{ '--backgroundnav': light ? '#edf2f8' : '#0a192f', '--navTextHover': light ? "#dc143c" : "#64ffda" }}>
      ...
      <div className='navDrawer' style={light ? { '--navTextHover': "black" } : { '--navTextHover': "#dc143c" }}>
        <i className="fas" onClick={openDrawer} style={{ color: light ? "black" : "rgba(255,255,255,0.9)", fontSize: "20px", padding: "0px" }}>
          <GiHamburgerMenu size='23px' style={{ padding: "10px 10px 6px 10px" }} />
        </i>
        {
          light
            ? <i className='fas' style={{ cursor: "pointer", fontSize: "20px", color: "#0a192f" }} onClick={() => setLight(false)}><FaMoon /></i>
      ...
      <div className='navDrawerBackdrop' style={{ display: drawer ? 'flex' : 'none', '--back1': light ? "#dc143cc5" : "#64ffdb9c", '--back2': light ? "#dc143c90" : "#64ffdd68" }}>
        ...
        <div className='drawerCont' style={light ? { '--navText': "black", '--navTextHover': "#edf2f8", background: "#edf2f8", '--hover': "#dc143c" } : { '--navText': "rgba(255,255,255,0.9)", '--navTextHover': "#4a5d80dd", background: "#0a192f", '--hover': "#64ffda" }}>
          <i className="fa" onClick={closeDrawer} style={{ color: light ? "black" : "rgba(255,255,255,0.9)", fontSize: "25px", marginLeft: "250px", padding: "0px" }}>
